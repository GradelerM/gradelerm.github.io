...
-   Comprendre la structure du code de l’application OpenLayers et

-   Créer un commit et héberger mon code sur GitHub

## Supports

[Cours : Outils de développement web](./05_diapos_ai.qmd){target="_blank"}

[Cours : Développer avec NodeJS et OpenLayers](./05_diapos_node_openlayers){target="_blank"}
...
Rendez-vous sur le [site officiel d’OpenLayers](https://openlayers.org/) et cherchez la section "Quick Start". Prenez le temps de parcourir la page, elle contient toutes les informations dont vous avez besoin. Ensuite, ouvrez un terminal dans votre dossier `geonum_docker` et tapez la commande suivante :
