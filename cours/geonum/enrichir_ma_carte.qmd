...
Fantastique ! Eh bien maintenant, débrouillez-vous pour [ajouter une échelle à votre carte](https://openlayers.org/en/latest/examples/scale-line.html). Ça devrait vous occuper un moment, j’espère.
